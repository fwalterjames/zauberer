...
def Leo_final_intro():
    ...
    print(
        f"Or just tiredness in general. This is the longest you've been away from the farm since {Leo.rank} school.🎓\n")
...
def leo_vs_berggrab():
    ...
    while not Leo_final_battle.game_over:
        Leo_final_battle.new_round()
        Leo_final_battle.takeTurn()
        Leo_final_battle.win_check()
