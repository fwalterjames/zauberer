...
Hera_final_battle = Battle()
Human = Hera
Demon = Berggrab


def hera_final_intro():
    print("🏕️ There is no beer here, just the tiredness of battle settling in\n")
    print(
        f"Or just tiredness in general. This is the longest you've been away from the farm since {Hera.rank} school.🎓\n")
        ...
        if curio == "A" or curio == "a":
            ...
            if scout == "A" or scout == "a":
                ...
                if future == "A" or future == "a":
                    ...
                    print("👤💬 What does it look like you're doing, lass?")
                    print(
...
def hera_vs_berggrab():
    ...
    while not Hera_final_battle.game_over:
        Hera_final_battle.new_round()
        Hera_final_battle.takeTurn()
        Hera_final_battle.win_check()
