...
Karminrot = Demon("Karminrot", "red mage", 25, 50, 100,
                  ", and his power comes from the dark, and from anger. The dark makes his spirit strong, but the anger makes his mind weak.", 14, 16.5, 15.5)
Phantast = Demon("Phantast", "dream engineer", 100, 25, 50,
                 ", which makes him powerful of mind and perhaps even spirit. But his mental focus means his body is likely his weakest aspect.", 10.5, 8, 9)
...
Erik_bridge_battle = Battle()
Human = Erik
Demon = Desto


def desto_v_erik():
    print("You reenter your body as Erik\n")
...
def desto_battle_intro():
    ...
    print("You get into your fighting pose. 😠💬 The last you're like to ever hear, yeah.🗡️")
    ...
    while not Erik_bridge_battle.game_over:
        Erik_bridge_battle.new_round()
        Erik_bridge_battle.takeTurn()
        Erik_bridge_battle.win_check()
