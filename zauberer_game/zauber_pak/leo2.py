...
Leo_bridge_battle = Battle()
Human = Leo
Demon = Desto


def desto_v_leo():
    print("You reenter your body as Leofstan\n")
...
def desto_battle_intro():
    ...
    print("You get into your fighting pose. 😠💬 The time for words is long past. Have at you, Admiral.🗡️")
    ...
    while not Leo_bridge_battle.game_over:
        Leo_bridge_battle.new_round()
        Leo_bridge_battle.takeTurn()
        Leo_bridge_battle.win_check()
