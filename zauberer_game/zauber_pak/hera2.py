...
def desto_v_hera():
    print("You reenter your body as Hera\n")
    ...
    if tower == "a" or tower == "A":
        ...
        print(
            f"💬👤The stranger says, {Desto}. Getting past the bridge will get us closer to Lord Berggrab\n")
...
def desto_battle_intro():
    ...
    print("He says, 🤖💬Are you sure you want those to be your last words, villager? and takes out a glowing sword 🤺\n")
    ...
    while not Hera_bridge_battle.game_over:
        Hera_bridge_battle.new_round()
        Hera_bridge_battle.takeTurn()
        Hera_bridge_battle.win_check()
