...
Sonny_final_battle = Battle()
Human = Sonata
Demon = Berggrab


def Sonny_final_intro():
    print("🏕️ There is no beer here, just the tiredness of battle settling in\n")
    print(
        f"Or just tiredness in general. This is the longest you've been away from the farm since {Sonata.rank} school.🎓\n")
...
def sonny_vs_berggrab():
    ...
    while not Sonny_final_battle.game_over:
        Sonny_final_battle.new_round()
        Sonny_final_battle.takeTurn()
        Sonny_final_battle.win_check()
